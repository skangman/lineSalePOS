...
// ตัว Express app ล้วนๆ ไม่มี app.listen() — ใช้ร่วมกันได้ทั้งรันเอง (src/index.ts)
// และรันแบบ serverless function บน Vercel (api/index.ts)
const app = express()
...
// Serve uploaded images — เหลือไว้เผื่อรันแบบ local/VM ที่ยังมี disk จริง
// (บน Vercel รูปใหม่ทั้งหมดจะถูกเก็บผ่าน Vercel Blob แทน ดู routes/uploads.ts)
